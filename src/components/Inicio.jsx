              ...
              <div className="card intro">
                <div className="card-body">
                  ...
                  <p className="card-text mt-5">
                    ...
                    sentimientos de tristeza, desesperanza, pérdida de interés
                    en actividades que antes disfrutaban, fatiga, dificultad
                    para concentrarse y pensamientos de muerte o suicidio. La
                    depresión es una de las enfermedades mentales más comunes en
                    todo el mundo. Según la Organización Mundial de la Salud
                    (OMS), se estima que 300 millones de personas en todo el
                    mundo sufren de depresión. En los Estados Unidos, se estima
                    que alrededor del 7% de los adultos han experimentado un
                    episodio de depresión mayor en el último año. Sin embargo,
                    es importante tener en cuenta que la depresión puede afectar
                    a cualquier persona, independientemente de su edad, género,
                    raza o antecedentes culturales.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4 d-flex align-items-center">
              <div className="card intro">
                <div className="card-body">
                  <p>
                    {" "}
                    Buscar ayuda profesional: La depresión es un trastorno
                    médico que requiere atención profesional. Por lo tanto, es
                    importante animar a la persona a buscar ayuda de un
                    profesional de la salud mental, como un psicólogo o un
                    psiquiatra.
                  </p>
                </div>
              </div>
              ...
              <div className="card intro">
                <div className="card-body">
                  <p>
                    ...
                    alguien está ahí para ellos y que les brinda apoyo
                    emocional. Escuchar sin juzgar y ofrecer comprensión.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4 d-flex align-items-center">
              <div className="card intro">
                <div className="card-body">
                  <p>
                    Ayudar en las tareas cotidianas: La depresión puede hacer
                    que las actividades cotidianas se sientan abrumadoras.
                    Ayudar con tareas como hacer la compra, cocinar, limpiar o
                    cuidar a los niños pueden ser de gran ayuda.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card intro">
                <div className="card-body">
                  <p>
                    ...
                    actividad física, como caminar o correr juntos, puede ayudar
                    a mejorar el estado de ánimo de la persona.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card intro">
                <div className="card-body">
                  <li className="card-text mt-3">
                    ...
                    de ellos tiene sus propios síntomas y formas de tratamiento.
                  </li>

                  <li className="mt-3">
                    Factores de riesgo: Algunos factores que pueden aumentar el
                    riesgo de desarrollar depresión incluyen antecedentes
                    familiares de depresión, estrés crónico, ciertos trastornos
                    médicos, abuso de sustancias y algunos medicamentos.
                  </li>

                  <li className="mt-3">
                    Tratamientos: Hay varios tratamientos disponibles para la
                    depresión, incluyendo psicoterapia y medicamentos
                    antidepresivos. A menudo, se utiliza una combinación de
                    ambos para lograr los mejores resultados.
                  </li>

                  <li className="mt-3">
                    Prevención: La prevención de la depresión puede incluir
                    cambios en el estilo de vida, como mantener una dieta
                    saludable, hacer ejercicio regularmente y participar en
                    actividades sociales. También es importante buscar
                    tratamiento para otros trastornos de salud mental que puedan
                    aumentar el riesgo de depresión, como la ansiedad.
                  </li>

                  <li className="mt-3">
                    Importancia de buscar ayuda: Si sospechas que tú o alguien
                    que conoces puede estar experimentando depresión, es
                    importante buscar ayuda de un profesional de la salud
                    mental. La depresión puede ser un trastorno grave que puede
                    tener un impacto significativo en la calidad de vida de una
                    persona, pero con el tratamiento adecuado, la mayoría de las
