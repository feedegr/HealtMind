...
export const Quiz = () => {
  ...
  const handleIndexSeleccionado = (index,preguntaId) => {
    setSumaIndices((sumaindices) => sumaindices + index);
    setPreguntasRespondidas((prevState) => ({
      ...prevState,         
      [preguntaId]: true,
    }));
  };
  ...
  return (
    <div className="container">
      <Pregunta 
        ...
        onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 1)}
      />
      <Pregunta
        ...
        onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 2)}
      />
      <Pregunta
       ...
       onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 3)}
      />
      <Pregunta
       ...
       onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 4)}
      />
      <Pregunta
       ...
       onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 5)}
      />
      <Pregunta
       ...
       onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 6)}
      />
      <Pregunta
       ...
       onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 7)}
      />
      <Pregunta
        ...
        onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 8)}
      />
      <Pregunta
       ...
       onIndexSeleccionado={(index) => handleIndexSeleccionado(index, 9)}
      />
      
        <Resultado sumaindices={sumaindices} respuestasCompletas={preguntasRespondidas} />
    </div>
  );
};
